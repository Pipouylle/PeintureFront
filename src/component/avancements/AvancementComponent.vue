               ...
               <v-list-group variant="outlined">
                  ...
                  demande => store.avancementModel.listCommande.some(
                     ...
                     <v-list-group variant="outlined">
                        ...
                        <TableOf :items="[this.store.avancementModel.listOF.filter(of => of.demande.id === demande.id && of.cabine === store.avancementModel.cabine)[0], ...this.store.avancementModel.listOF.filter(of => of.demande.id === demande.id && of.cabine === store.avancementModel.cabine)[0].avancements]"/>
                     </v-list-group>
                  </v-list-item>
               </v-list-group>
            </v-list-item>
